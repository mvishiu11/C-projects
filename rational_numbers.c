...
{
	rational num1;
	rational num2 = create_rational(3, 5);
	input_rational(&num1);
...
{
	rational difference;
	difference.denominator = num1->denominator * num2->denominator;
	difference.numerator = num1->numerator * num2->denominator - num2->numerator * num1->denominator;
	return difference;
}
